...
export class FeedbackService {
    ...
    public getAllScheduleFeedback() : Observable<Array<ScheduleFeedback>> {
        //return this.httpClient.get<User>(`${environment.backendUrl}/user/${username}`);
        return this.httpClient.get<Array<ScheduleFeedback>>(`${environment.backendUrl}/feedback/schedule`, {headers:{
